    ...
    if cfg.pretrained_path is not None:
        if cfg.mode == 'resume':
            ...
            if cfg.mode == 'test':
                ...
                torch.save(model.inputs_quant.scale, './data/TensorData_quanti8b/model_inputs_quant/scale.pt')
                torch.save(model.inputs_quant.zero_point, './data/TensorData_quanti8b/model_inputs_quant/zero_point.pt')
...
def save_Tensor(layer, layer_name, isGrouper=False, isWeight=False, isBias=False, isFakeQ=False, isBN=False, isQueryAndGroup=False, isGroupAll=False):
    path=r'./data/TensorData_quanti8b/'+layer_name
